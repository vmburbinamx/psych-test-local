...
El ranking de las escuelas por nivel académico, de acuerdo a los datos disponibles en el *path* **data/test_data.csv**. Se entenderá que el nivel académico está definido por el número de respuestas correctas en la evaluación.
